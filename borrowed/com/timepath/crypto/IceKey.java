...
public class IceKey {
    ...
    /**
     * 8-bit Galois Field multiplication of a by b, modulo m. Just like
     * arithmetic multiplication, except that additions and subtractions are
     * replaced by XOR.
     */
    ...
    /**
     * 8-bit Galois Field exponentiation. Raise the base to the power of 7,
     * modulo m.
     */
    ...
    private int roundFunc(int p, int subkey[]) {
        int tl, tr; // Expanded 40-bit values. Left and right half expansions
        int al, ar; // Salted expanded 40-bit values
